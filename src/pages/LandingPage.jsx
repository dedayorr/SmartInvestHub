...
export default function LandingPage() {
  return (
    <div className="mx-[5%]">
      <div className="bg-[#000] h-[460px] px-[4%] mt-[-20%] pt-[30%] rounded-bl-[35px] rounded-br-[35px] md:h-[650px] lg:pt-[20%] lg:flex lg:h-[750px] lg:justify-between lg:px-[2%] lg:items-center lg:gap-[55px]">
        {/* ===Header Section=== */}
        <div className="lg:w-[60%]">
          ...
          <br />
          <button className="bg-primaryColor p-[10px] rounded-[30px] text-[15px] hover:bg-white md:text-[25px] w-[100px] lg:text-[20px] md:w-[150px]">
            Get Stated
          </button>
        </div>
